...
**Thumb reach.** Measured from the **bottom safe edge**, the Dial's top edge sits 411 pt up on SE (647 − 236) and 452 pt up on Pro Max (922 − 470) — a 41 pt difference across a 289 pt difference in screen height. Every interactive target in PROBE lives within 460 pt of the bottom safe edge on both devices. The throat (583 pt up on SE) and the ribbon (471 pt at its top edge) sit above that band on both, deliberately: they are read, not touched, except for two low-frequency gestures (throat swipe, ribbon-load tap) which are convenience paths with a Dial equivalent.
