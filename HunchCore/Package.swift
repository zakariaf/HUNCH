...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "Rounds", dependencies: ["Laws", "Glyphs", "Tokens", "Drift"],
            swiftSettings: coreSettings),
        ...
        .testTarget(
            name: "DriftTests",
            dependencies: ["Drift", "HunchTestSupport"],
            swiftSettings: coreSettings
        ),
        ...
        .target(
            name: "Onboarding", dependencies: ["Glyphs", "Tokens"], swiftSettings: coreSettings),

        .testTarget(
            name: "OnboardingTests",
            dependencies: ["Onboarding", "Laws", "HunchTestSupport"],
            swiftSettings: coreSettings
        ),

        .target(
            name: "Archive", dependencies: ["Laws", "Glyphs", "Rounds"],
            swiftSettings: coreSettings),

        .testTarget(
            name: "ArchiveTests",
            dependencies: ["Archive", "HunchTestSupport"],
            swiftSettings: coreSettings
        ),

        .target(
            name: "Persistence", dependencies: ["Laws", "Glyphs", "Rounds"],
            swiftSettings: coreSettings),
